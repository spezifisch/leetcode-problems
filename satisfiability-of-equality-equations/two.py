        ...
        for eq in equations:
            ...
            if equals:
                if g_lop == g_rop:
                    ...
                    if len(g_rop.equal) + len(g_rop.unequal) > len(g_lop.equal) + len(g_lop.unequal):
...
# Runtime: 52 ms, faster than 17.84% of Python3 online submissions for Satisfiability of Equality Equations.
# Memory Usage: 13.1 MB, less than 5.06% of Python3 online submissions for Satisfiability of Equality Equations.
