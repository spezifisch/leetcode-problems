...
class Solution:
    ...
    def floodFill(
        ...
        while len(queue):
            ...
            for offset_r, offset_c in self.NEIGHBORS:
...
# Runtime: 64 ms, faster than 83.04% of Python3 online submissions for Flood Fill.
# Memory Usage: 13.4 MB, less than 6.33% of Python3 online submissions for Flood Fill.
